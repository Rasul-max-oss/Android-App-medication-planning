...
public class TabletContentProvider extends ContentProvider {
    ...
    public Uri insert( Uri uri, ContentValues contentValues) {
        ...
        //******** возможно ошибка
        String quntity=contentValues.getAsString(TabletContract.TabletEntry.COLUMN_QUNTITY);;
        if (quntity==null){
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        if (contentValues.containsKey(TabletContract.TabletEntry.COLUMN_QUNTITY)){
            String quntity=contentValues.getAsString(TabletContract.TabletEntry.COLUMN_QUNTITY);;
            if (quntity==null){
                throw new IllegalArgumentException("Введите значение для quntity");
            }
